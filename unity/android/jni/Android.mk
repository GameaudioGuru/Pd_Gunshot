...
# audiolib.so
include $(CLEAR_VARS)
LOCAL_MODULE := tutorial_laser_lib
LOCAL_MODULE_FILENAME := libHv_tutorial_laser_AudioLib
LOCAL_CFLAGS := -std=c11 -DNDEBUG -DHV_SIMD_NEON -O3 -ffast-math -fPIC
LOCAL_CPPFLAGS := -std=c++11
...
# libplugin.so
include $(CLEAR_VARS)
LOCAL_MODULE := tutorial_laser_plugin
LOCAL_MODULE_FILENAME := AudioPlugin_Hv_tutorial_laser
LOCAL_CFLAGS := -std=c11 -DNDEBUG -DHV_SIMD_NEON -O3 -ffast-math -fPIC
LOCAL_CPPFLAGS := -std=c++11
